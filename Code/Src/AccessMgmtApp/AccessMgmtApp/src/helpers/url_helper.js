...
//LOGIN
export const ADMIN_LOGIN = "/api/Account/login";
...
//APPROVERS
export const GET_APPROVERS = "/api/Approver?companyId=";
...
//GroupsManagement
export const GET_COMPGROUPS = "/api/Group?companyId=";
...
export const APPROVER_DUPLICATE_CHECK = (approverEmail, compid) =>
